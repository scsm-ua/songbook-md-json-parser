...
const { getDefaultPaths, commonRoot } = require('./config');
...
function parseContents(options = {}) {
    ...
    const rootDir = commonRoot(contentsFile, outputFile);
    console.log(`Root: ${rootDir}`);
    console.log(`Parsing contents from: ${path.relative(rootDir, contentsFile)}`);
    ...
    if (saveToFile) {
        ...
        console.log(`✓ Contents saved to: ${path.relative(rootDir, outputFile)}`);
    }
...
function parseIndex(options = {}) {
    ...
    const rootDir = commonRoot(indexFile, outputFile);
    console.log(`Root: ${rootDir}`);
    console.log(`Parsing index from: ${path.relative(rootDir, indexFile)}`);
    ...
    if (saveToFile) {
        ...
        console.log(`✓ Index saved to: ${path.relative(rootDir, outputFile)}`);
    }
